...
export async function generateAioArticle(payload: ArticleGenerationPayload) {
  ...
  const result = await createStructuredResponse<ArticleGenerationResult>({
    ...
    instructions: [
      ...
      "Avoid commodity content and generic AI-like filler. Do not lean on vague phrases such as 近年, 重要です, 重要になります, 注目されています, 求められます, 欠かせません, と言えるでしょう, いかがでしょうか, 本記事では, わかりやすく解説, 詳しく解説, を紹介します, in this article, this article explains, it is important to, various, many companies, can help, improve efficiency, should consider, recommended to, best practices, streamline, enhance productivity, leverage, today's fast-paced digital landscape, today's digital landscape, today's rapidly evolving landscape, ever-evolving landscape, comprehensive guide, delve into, navigate the complexities, game-changer, unlock the potential, or empower businesses unless they are genuinely necessary and supported by the material.",
